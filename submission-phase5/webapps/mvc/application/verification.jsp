...
<html>
	...
	<body>
		...
		<div class="field-container">
				<html:form action="/mvc/application/verification.do" method="GET">
					<html:submit property="submit" value="Submit Application"/> 
					<html:submit property="submit" value="Cancel"/> 
				</html:form>
			</div>
	</body>
</html>