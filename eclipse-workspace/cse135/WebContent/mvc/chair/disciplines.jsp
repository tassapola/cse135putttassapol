...
<html>
	...
	<body>
		...
		<div class="node">
			...
			<div class="info">
				<%
					ArrayList<String> d = (ArrayList<String>)request.getAttribute("discipline");
				...
				%>
					...
					%>
						<tr>
							<td><%= d.get(i) %></td>
							<td>
								<html:link action="/mvc/chair/viewdiscipline">
									<html:param name="discipline"><%= d.get(i) %></html:param>
									<%= c.get(i) %>
								</html:link>
							</td> 
						</tr> 
